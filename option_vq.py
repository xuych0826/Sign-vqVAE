...
def get_args_parser():
    ...
    parser.add_argument("--nb-code", type=int, default=64, help="nb of embedding")
    ...
    parser.add_argument("--output-emb-width", type=int, default=64, help="output embedding width")
